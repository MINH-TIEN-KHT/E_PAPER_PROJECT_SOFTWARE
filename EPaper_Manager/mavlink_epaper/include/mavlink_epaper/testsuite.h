...
static void mavlink_test_display_string(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	17,
	84,
	"GHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJK",
	};
	...
	mavlink_msg_display_string_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_display_string_pack(system_id, component_id, &msg , packet1.xpos , packet1.ypos , packet1.mode , packet1.datalength , packet1.text );
	mavlink_msg_display_string_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_display_string_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.xpos , packet1.ypos , packet1.mode , packet1.datalength , packet1.text );
	mavlink_msg_display_string_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_display_string_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_display_string_send(MAVLINK_COMM_1 , packet1.xpos , packet1.ypos , packet1.mode , packet1.datalength , packet1.text );
	mavlink_msg_display_string_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_draw_hline(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_draw_hline_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_draw_hline_pack(system_id, component_id, &msg , packet1.xpos , packet1.ypos , packet1.length );
	mavlink_msg_draw_hline_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_draw_hline_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.xpos , packet1.ypos , packet1.length );
	mavlink_msg_draw_hline_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_draw_hline_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_draw_hline_send(MAVLINK_COMM_1 , packet1.xpos , packet1.ypos , packet1.length );
	mavlink_msg_draw_hline_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_draw_vline(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_draw_vline_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_draw_vline_pack(system_id, component_id, &msg , packet1.xpos , packet1.ypos , packet1.length );
	mavlink_msg_draw_vline_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_draw_vline_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.xpos , packet1.ypos , packet1.length );
	mavlink_msg_draw_vline_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_draw_vline_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_draw_vline_send(MAVLINK_COMM_1 , packet1.xpos , packet1.ypos , packet1.length );
	mavlink_msg_draw_vline_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_draw_rect(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_draw_rect_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_draw_rect_pack(system_id, component_id, &msg , packet1.xpos , packet1.ypos , packet1.height , packet1.width );
	mavlink_msg_draw_rect_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_draw_rect_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.xpos , packet1.ypos , packet1.height , packet1.width );
	mavlink_msg_draw_rect_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_draw_rect_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_draw_rect_send(MAVLINK_COMM_1 , packet1.xpos , packet1.ypos , packet1.height , packet1.width );
	mavlink_msg_draw_rect_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_draw_fill_rect(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_draw_fill_rect_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_draw_fill_rect_pack(system_id, component_id, &msg , packet1.xpos , packet1.ypos , packet1.height , packet1.width );
	mavlink_msg_draw_fill_rect_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_draw_fill_rect_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.xpos , packet1.ypos , packet1.height , packet1.width );
	mavlink_msg_draw_fill_rect_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_draw_fill_rect_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_draw_fill_rect_send(MAVLINK_COMM_1 , packet1.xpos , packet1.ypos , packet1.height , packet1.width );
	mavlink_msg_draw_fill_rect_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_draw_image(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_draw_image_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_draw_image_pack(system_id, component_id, &msg , packet1.xpos , packet1.ypos , packet1.xsize , packet1.ysize , packet1.datalength , packet1.data );
	mavlink_msg_draw_image_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_draw_image_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.xpos , packet1.ypos , packet1.xsize , packet1.ysize , packet1.datalength , packet1.data );
	mavlink_msg_draw_image_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_draw_image_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_draw_image_send(MAVLINK_COMM_1 , packet1.xpos , packet1.ypos , packet1.xsize , packet1.ysize , packet1.datalength , packet1.data );
	mavlink_msg_draw_image_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_refresh_display(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_refresh_display_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_refresh_display_pack(system_id, component_id, &msg , packet1.dummy );
	mavlink_msg_refresh_display_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_refresh_display_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.dummy );
	mavlink_msg_refresh_display_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_refresh_display_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_refresh_display_send(MAVLINK_COMM_1 , packet1.dummy );
	mavlink_msg_refresh_display_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_clear_display(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_clear_display_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_clear_display_pack(system_id, component_id, &msg , packet1.color );
	mavlink_msg_clear_display_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_clear_display_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.color );
	mavlink_msg_clear_display_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_clear_display_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_clear_display_send(MAVLINK_COMM_1 , packet1.color );
	mavlink_msg_clear_display_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_set_font(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_set_font_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_font_pack(system_id, component_id, &msg , packet1.font );
	mavlink_msg_set_font_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_font_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.font );
	mavlink_msg_set_font_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_set_font_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_font_send(MAVLINK_COMM_1 , packet1.font );
	mavlink_msg_set_font_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
